...
import com.louisgeek.chat.video.helper.CallPlayerHelper;
import com.louisgeek.chat.video.listener.PeerConnectionObserverListener;
...
import com.louisgeek.chat.video.video.CameraVideoCapturerHelper;
import com.louisgeek.chat.video.video.PeerConnectionHelper;
import com.louisgeek.chat.video.video.VideoChatSocketHelper;
...
*/
    ...
    private void initRenderer() {
        ...
        //后置摄像头一般设置成 false
        mLocalSurfaceViewRenderer.setMirror(!CallVideoHelper.CameraStatus_BACK.equals(mCameraStatus));
        //视频画面缩放模式
//       自动适应屏幕比例， 画面存在被裁剪的可能
        ...
        mPeerConnection = mPeerConnectionFactory.createPeerConnection(rtcConfig,
                new PeerConnectionObserverListener() {
                    ...
                    public void onIceCandidate(IceCandidate iceCandidate) {
                        //
                        MessageSocketAdapter.sendCandidate(new VideoChatInfoModel(
...
//        ToastManager.show("切到 Normal 模式，关闭外放");
    ...
    protected void onVideoChatAgree() {
        //发送 offer
        VideoChatSocketHelper.callerSendOffer(mPeerConnection, mSdpMediaConstraints);
    }
    ...
    protected void onVideoChatOffer(ChatInfoModel<VideoChatSdpInfoModel> chatInfoModel) {
        ...
        VideoChatSocketHelper.calleeReceiveOffer(mPeerConnection, description);
        //
        VideoChatSocketHelper.calleeSendAnswer(mPeerConnection, mSdpMediaConstraints);
        //停止铃声播放
        CallPlayerHelper.release();
...
//        ToastManager.show("切到 Call 模式，关闭外放");
    ...
    protected void onVideoChatAnswer(ChatInfoModel<VideoChatSdpInfoModel> chatInfoModel) {
        String description = chatInfoModel.chatInfo.description;
        //
        VideoChatSocketHelper.callerReceiveAnswer(mPeerConnection, description);
        //停止铃声播放
        CallPlayerHelper.release();
        mAudioManager.setMode(AudioManager.MODE_IN_COMMUNICATION);
        mAudioManager.setSpeakerphoneOn(false);
