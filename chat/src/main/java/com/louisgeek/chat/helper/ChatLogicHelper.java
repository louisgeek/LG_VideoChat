...
//            SocketClient.get().releaseSocket();
    ...
    public static boolean isBeBusy() {
        boolean isBusy = ChatLogicHelper.mDeviceStatus == DeviceStatus.CallIn
                || ChatLogicHelper.mDeviceStatus == DeviceStatus.CallOut
                || ChatLogicHelper.mDeviceStatus == DeviceStatus.Chatting
                || ChatLogicHelper.mDeviceStatus == DeviceStatus.CallInWay
                || ChatLogicHelper.locationedUserId != null;
        return isBusy;
    }
    ...
    public static boolean isNurseStationBusy() {
        return ChatLogicHelper.locationedUserId != null || mNurseStationCallStatus.size() > 0;
    }
